...
func showWeatherApp() {
	...
	r, _ := LoadResourceFromPath("logo\\weather_logo.png")
	w.SetIcon(r)
	...
	clickMe := widget.NewButton("Click To Get Weather", func() {
		resp, err := http.Get("https://api.openweathermap.org/data/2.5/weather?q=" + selection + "&appid=966b2309a523aee0b67e972eaa55254e")
		if err != nil {
